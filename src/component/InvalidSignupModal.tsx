...
export const InvalidSignupModal = ( { show, setShow }:Props ) => {
    ...
    return (
        <Modal 
            ...
            <ModalContent className="">
                <ModalHeader className="flex flex-col gap-1">Invalid Sign Up</ModalHeader>
                <ModalBody>
                    <p>The credentials provided are already taken</p>
                </ModalBody>
                <ModalFooter>
